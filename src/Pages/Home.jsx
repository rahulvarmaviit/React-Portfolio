...
const WORDS = ["Computer Science Student", "Tech Enthusiast", "Gamer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/rahulvarmaviit" },
  { icon: Linkedin, link: "http://www.linkedin.com/in/rahul-varma-vatsavai-62a051290" },
  { icon: Instagram, link: "https://www.instagram.com/rahulvarma.07?igsh=MXRtdjBtc24zNXZn" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  strong foundation in programming, Proficient in designing and developing scalable applications.
                </p>
